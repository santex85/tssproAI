...
export const ru = {
  ...
  auth: {
    ...
    intervalsCompleteCta: "Завершить",
    ...
    checkEmailHint: "Если аккаунт с таким email существует, вы получите письмо со ссылкой для сброса пароля.",
  ...
  wellness: {
    ...
    deleteWellnessTitle: "Удалить запись wellness?",
    deleteWellnessMessage: "Сон, RHR и HRV за эту дату будут удалены.",
  ...
  camera: {
    ...
    workoutRecognized: "Распознана тренировка",
    workoutSaved: "Тренировка сохранена.",
    workoutSportType: "Тип",
  ...
  pricing: {
    ...
    proFeatures: "Что входит в Pro:",
    proF1: "Безлимитный анализ еды по фото",
    proF2: "Расширенный учёт нутриентов",
    proF3: "ИИ-оркестратор для рекомендаций",
    proF4: "Расширенная аналитика и тренды",
    proF5: "Чат с файлами и изображениями",
    proF6: "Еженедельные AI-сводки",
  },
  billing: {
...
export const en = {
  ...
  auth: {
    ...
    checkEmailHint: "If an account exists with this email, you will receive a reset link.",
  ...
  wellness: {
    ...
    deleteWellnessTitle: "Delete wellness record?",
    deleteWellnessMessage: "Sleep, RHR and HRV for this date will be removed.",
  ...
  camera: {
    ...
    workoutRecognized: "Workout recognized",
    workoutSaved: "Workout saved.",
    workoutSportType: "Type",
  ...
  pricing: {
    ...
    proFeatures: "What's included in Pro:",
    proF1: "Unlimited AI food analyses",
    proF2: "Extended nutrient tracking",
    proF3: "AI Orchestrator for recommendations",
    proF4: "Advanced insights and trends",
    proF5: "Chat with files and images",
    proF6: "Weekly AI summaries",
  },
  billing: {
